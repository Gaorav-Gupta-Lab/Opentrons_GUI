...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.closeGUI_btn.setGeometry(QRect(310, 650, 351, 81))
        ...
        self.simulate_run_btn.setGeometry(QRect(281, 320, 451, 51))
        ...
        self.run_simulation_output.setGeometry(QRect(51, 390, 921, 231))
        font2 = QFont()
        ...
        self.select_program_combobx.setGeometry(QRect(281, 220, 451, 51))
        self.select_program_label = QLabel(self.centralwidget)
        self.select_program_label.setObjectName(u"select_program_label")
        self.select_program_label.setGeometry(QRect(280, 170, 451, 41))
        font3 = QFont()
