...
from PySide2.QtCore import QObject, QRectF, QFile
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # self.tsv_file_select_btn = self.loader.findChild(QtWidgets.QPushButton, "tsv_file_select_btn")
        self.tsv_file_select_btn = QMainWindow.findChild(self, QPushButton, "tsv_file_select_btn")

        self.tsv_file_select_btn.pressed.connect(self.file_transfer())
        self.load_ui()
